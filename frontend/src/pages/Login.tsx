...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLocalError(error || 'Грешка при логин');
    }
  };
              ...
              {error?.includes('Email not verified') && (
                <div className="mt-2 text-xs text-red-600">
                  ...
                  <ul className="list-disc list-inside mt-1 space-y-1">
                    <li>Провери своя inbox и папката Spam</li>
                    <li>Намери имейла от LearnMate</li>
                    <li>Кликни на линка "Потвърди имейл адрес"</li>
                    <li>След верификацията можеш да се логнеш</li>
                  </ul>
                </div>
              )}
            </div>
