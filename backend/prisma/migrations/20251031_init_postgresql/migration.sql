...
-- AddForeignKey
ALTER TABLE "Knowledge" ADD CONSTRAINT "Knowledge_aiStudentId_fkey" FOREIGN KEY ("aiStudentId") REFERENCES "AIStudent"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Session" ADD CONSTRAINT "Session_aiStudentId_fkey" FOREIGN KEY ("aiStudentId") REFERENCES "AIStudent"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
